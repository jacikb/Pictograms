...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Ja chcę", "p_ja_chce", true, 3);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Nie chcę!", "p_nie_chce", true, 4);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Koniec", "p_koniec", true, 5);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Toaleta", "p_toaleta", true, 6);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Pić", "p_pic", true, 7);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Jeść", "p_jesc", true, 8);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Kanapka", "p_kanapka", true, 9);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Śniadanie", "p_sniadanie", true, 10);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Obiad", "p_obiad", true, 10);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Owoce", "p_owoce", true, 12);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Czekolada", "p_czekolada", true, 13);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Jabłko", "p_jablko", true, 14);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Komputer", "p_komputer", true, 15);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Jeszcze", "p_jeszcze", true, 16);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Dom", "p_dom", true, 17);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Plecak", "p_plecak", true, 18);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Spacer", "p_spacer", true, 19);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Zimno", "p_zimno", true, 20);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Odpocząć", "p_odpoczac", true, 21);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Kąpać", "p_kapac", true, 22);
        addOneOnCreate(db, pictogramModel);
        pictogramModel.createNew("Spać", "p_spac", true, 23);
        addOneOnCreate(db, pictogramModel);
    }
